...
const ContactMe: React.FC = () => {
  return (
    <div style={{ padding: '100px 5% 40px', maxWidth: '800px', margin: '0 auto', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
      <h1 style={{ fontSize: 'clamp(1.8rem, 5vw, 3rem)', marginBottom: '20px' }}>Get In Touch</h1>
      <p style={{ textAlign: 'center', fontSize: 'clamp(0.9rem, 2vw, 1.2rem)', color: '#b3b3b3', marginBottom: '50px', maxWidth: '600px', lineHeight: '1.6' }}>
